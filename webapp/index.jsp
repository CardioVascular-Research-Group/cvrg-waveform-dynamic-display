...
<html>
    <head>
	    ...
	    <link rel="stylesheet" href="static/gridstack/gridstack.css" type="text/css" />
        <link rel="search" type="application/opensearchdescription+xml" href="/open-search/description.xml" title="DSpace"/>
		<script type='text/javascript' src="static/js/jquery/jquery-1.10.2.min.js"></script>
		<script type='text/javascript' src='static/js/jquery/jquery-ui-1.10.3.custom.min.js'></script>
		<script type='text/javascript' src='static/js/bootstrap/bootstrap.min.js'></script>
		<script type='text/javascript' src='static/js/AutofillJavascript.js'></script> 
...
<%	
	...
	String subjectId = "2224BN1416911131-20141224-184234";
	String testQuery = tdb.retrieveMetricList(subjectId);
%>
...
<div class="container">
			...
			<div id="queryBox2" class="col-md-6">
					<p><strong>Subject Id: </strong><input type="text" size="40" id="subjectid-field" value="<%=subjectId%>"> <span class="littleNote"> <!-- preset datasets to query against (try: ncc1701, ncc1701A, ncc1701B, ncc1701C, ncc1701D) --></span></p>
				    ...
				    <p><strong>Start Time: </strong><input type="text" size="15" id="start-field" value="1419379200"><span class="littleNote"> unix time value: (1419457354 for smaller range)</span></p>
				    <p><strong>End Time: </strong><input type="text" size="15" id="end-field" value="1419465600"><span class="littleNote">  unix time value: (1419457364 for smaller range)</span></p>
	        ...
	        <div id="dataBox" class="col-md-12">
				...
				<div id="vitContainer" class="grid-stack" data-gs-width="12"></div>
				<div id="ecgContainer" class="grid-stack" data-gs-width="12"></div>
<!-- 				<button onclick="activateResize()">Click me</button> -->
			<div id="availMetrics" class="queryList"><%=testQuery%></div>
		<script>
